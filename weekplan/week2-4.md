...
The final git tag keeps this Markdown report, the main README reproduction instructions, configs, and code needed to regenerate the outputs. Generated experiment outputs are intentionally not tracked in the final tag.
...
- Generated metrics, tables, figures, and memo outputs; these should be regenerated from the README commands.
- Extra `reports/` files; the required report is this `weekplan/week2-4.md`.
